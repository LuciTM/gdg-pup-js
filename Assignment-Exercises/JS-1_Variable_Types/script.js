...
// Using let
let name = "Pauleanna Tolentino"; // Define a string here, e.g., "Juan Cruz"
let age = 20; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["gaming", "reading", "writing"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
// Using const
const pi = 3.14; // Define a number here, e.g., 3.14159
const birthYear = 2005; // Define a number here, e.g., 1990
const isEmployed = false; // Define a boolean here, e.g., true or false
const favoriteBooks = ["ILYS 1892", "Hunger Games", "Percy Jackson"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Valenzuela"; // Define a string here, e.g., "New York"
var temperature = 22.4; // Define a number here, e.g., 22.5
var hasPets = true; // Define a boolean here, e.g., true or false
var colors = ["purple", "blue", "yellow"]; // Define an array here, e.g., ["red", "green", "blue"]
